...
--
-- Host: localhost
-- Generation Time: Jan 21, 2021 at 12:32 PM
...
--
-- Database: `predicting_stock_markettrends`
--
CREATE DATABASE IF NOT EXISTS `predicting_stock_markettrends` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `predicting_stock_markettrends`;
...
('rgtmlzrts4y1dofdegwc4m62z222mgt1', 'eyJ1c2VyaWQiOjE2fQ:1l2Z0p:BFQyJDL36YBdMZoYs51a7KduQvsaDRSNdu0ylXpTWOA', '2021-02-04 12:24:31.731224'),
...
(16, 'Raju', 'Raju123@gmail.com', 'Raju', '9535866270', 'India', 'Karnataka', 'Bangalore');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_predicting_stock_markettrends_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_predicting_stock_markettrends_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `names` varchar(300) NOT NULL,
  `Company_Category` varchar(300) NOT NULL,
  `Opening_Price` varchar(300) NOT NULL,
  `Date_Of_Opening` varchar(300) NOT NULL,
  `Closing_Price` varchar(300) NOT NULL,
  `Date_Of_Closing` varchar(300) NOT NULL,
  `volume` varchar(300) NOT NULL,
  `Profit` varchar(300) NOT NULL,
  `prices_drop` varchar(300) NOT NULL,
  `Stock_Market_Trends` varchar(300) NOT NULL,
  `Stock_Exchange_By` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Table structure for table `remote_user_stock_market_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_stock_market_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
